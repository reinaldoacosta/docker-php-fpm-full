...
docker build -f Dockerfile8.4 . -t detallado/php-fpm-full:8.4
docker build -f Dockerfile8.5 . -t detallado/php-fpm-full:8.5
...
docker build -f Dockerfile8.4-alpine . -t detallado/php-fpm-full:8.4-alpine
docker build -f Dockerfile8.5-alpine . -t detallado/php-fpm-full:8.5-alpine
...
docker push detallado/php-fpm-full:8.4
docker push detallado/php-fpm-full:8.5
...
docker push detallado/php-fpm-full:8.4-alpine
docker push detallado/php-fpm-full:8.5-alpine
